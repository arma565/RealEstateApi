...
namespace RealEstate.Services.Properties;
  ...
  interface IPropertyRepositoryService
{
    #region Property
    Task<IEnumerable<RealEstateProperty>> GetPropertyListDescendingAsync();
    Task<IEnumerable<RealEstateProperty>> GetPropertyListAscendingAsync();
    Task<IEnumerable<RealEstateProperty>> GetPropertyListDateModifiedAsync();
    Task<RealEstateProperty?> GetPropertyAsync(Guid propertyId);
    Task<RealEstateProperty?> AddPropertyAsync(RealEstateProperty property);
    Task UpdatePropertyAsync(RealEstateProperty property);
    Task DeletePropertyAsync(RealEstateProperty property);
    Task DeleteAllPropertiesAsync();
    Task<RealEstateProperty?> FindPropertyByPlatesNumberAsync(string platesNumber);
    Task<bool> IsPropertyExistAsync(string plateNumber);
    #endregion
    #region PropertyImage
    Task<List<PropertyImage>> GetPropertyImageListAsync();
    Task<PropertyImage?> GetPropertyImageAsync(Guid propertyImageID);
...
public sealed class ProeprtyRepositoryService(AppDbContext context,
                                        ImageService imageService) : IPropertyRepositoryService
{
    ...
    #region Property
    public async Task<IEnumerable<RealEstateProperty>> GetPropertyListDescendingAsync() =>
          await _context
            .Properties
            .AsNoTracking()
    ...
    public async Task<IEnumerable<RealEstateProperty>> GetPropertyListAscendingAsync() =>
        await _context
            .Assets
            .AsNoTracking()
            .Include(prop => prop.Persons)
    ...
    public async Task<IEnumerable<RealEstateProperty>> GetPropertyListDateModifiedAsync() =>
        await _context
            .Assets
            .AsNoTracking()
            .Include(prop => prop.Persons)
